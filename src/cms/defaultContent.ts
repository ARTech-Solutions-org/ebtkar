...
export const defaultContent: SiteContent = {
  ...
  about: {
    ...
    heroSubtitle:
      "جمعية الابتكار والاستدامة المجتمعية جمعية وطنية سعودية غير ربحية، تأسست بهدف تعزيز ثقافة الابتكار، ودعم مسيرة الاستدامة المجتمعية في المملكة العربية السعودية.",
