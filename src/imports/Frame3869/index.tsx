import svgPaths from "./svg-jywq1idt3h";
              ...
              <div className="relative size-full">
                <svg className="absolute block inset-0 size-full" fill="none" height="66" preserveAspectRatio="none" viewBox="0 0 66 66" width="66">
                  <g id="Group 1">
                    ...
                    <g id="arrow_upward">
                      <mask height="30" id="mask0_0_448" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="30" x="18" y="18">
        ...
        <div className="absolute inset-[41.1%_65.32%_27.04%_14.67%] overflow-clip" data-name="Layer_1">
          ...
          <div className="absolute inset-[0_0.12%_0_70.53%]" data-name="Group">
            <svg className="absolute block inset-0 size-full" fill="none" height="85.3862" preserveAspectRatio="none" viewBox="0 0 85.6964 85.3862" width="85.6964">
              <g id="Group">
                <path clipRule="evenodd" d={svgPaths.p1191e780} fill="url(#paint0_linear_0_107)" fillRule="evenodd" id="Vector" />
                <path d={svgPaths.p37de6300} fill="url(#paint1_linear_0_107)" id="Vector_2" />
                <path d={svgPaths.p1ee50c00} fill="white" id="Vector_3" />
                <path d={svgPaths.p35d15700} fill="url(#paint2_linear_0_107)" id="Vector_4" />
                <path d={svgPaths.pa998900} fill="white" id="Vector_5" />
                <path d={svgPaths.p1e886100} fill="url(#paint3_linear_0_107)" id="Vector_6" />
                <path d={svgPaths.p2b6c6cf0} fill="white" id="Vector_7" />
                <path d={svgPaths.p148cbb00} fill="url(#paint4_linear_0_107)" id="Vector_8" />
                <path d={svgPaths.p1da39e80} fill="white" id="Vector_9" />
              </g>
              <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_107" x1="25.9072" x2="55.5492" y1="61.4936" y2="28.5487">
                  <stop stopColor="#92278F" />
                  <stop offset="0.5" stopColor="#3777BC" />
                  <stop offset="1" stopColor="#00C0F3" />
                </linearGradient>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_107" x1="45.3728" x2="83.848" y1="15.8015" y2="27.9999">
                  <stop stopColor="white" stopOpacity="0" />
                  <stop offset="0.51" stopColor="#5C2D91" />
                  <stop offset="1" stopColor="#00AEEF" />
                </linearGradient>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_107" x1="18.8632" x2="26.3558" y1="38.4981" y2="-1.13239">
                  <stop stopColor="white" stopOpacity="0" />
                  <stop offset="0.51" stopColor="#5C2D91" />
                  <stop offset="1" stopColor="#00AEEF" />
                </linearGradient>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_107" x1="39.0032" x2="4.99172" y1="76.74" y2="55.0202">
                  <stop stopColor="white" stopOpacity="0" />
                  <stop offset="0.51" stopColor="#5C2D91" />
                  <stop offset="1" stopColor="#00AEEF" />
                </linearGradient>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_0_107" x1="67.9794" x2="58.8531" y1="45.8459" y2="85.134">
                  <stop stopColor="white" stopOpacity="0" />
                  <stop offset="0.51" stopColor="#5C2D91" />
                  <stop offset="1" stopColor="#00AEEF" />
                </linearGradient>
  ...
  return (
    <div className="absolute h-[484.718px] left-[calc(50%+87.47px)] opacity-25 top-[151px] w-[486.067px]" data-name="Isolation_Mode">
      <svg className="absolute block inset-0 size-full" fill="none" height="484.718" preserveAspectRatio="none" viewBox="0 0 486.067 484.718" width="486.067">
        <g clipPath="url(#clip0_0_299)" id="Isolation_Mode">
          <path clipRule="evenodd" d={svgPaths.peb53500} fill="url(#paint0_linear_0_299)" fillRule="evenodd" id="Vector" />
          <path d={svgPaths.p30c6e400} fill="url(#paint1_linear_0_299)" id="Vector_2" />
          <path d={svgPaths.p277ccc00} fill="white" id="Vector_3" />
          <path d={svgPaths.p2a8fec80} fill="url(#paint2_linear_0_299)" id="Vector_4" />
          <path d={svgPaths.p199b8380} fill="white" id="Vector_5" />
          <path d={svgPaths.p2a0ab200} fill="url(#paint3_linear_0_299)" id="Vector_6" />
          <path d={svgPaths.p3439d200} fill="white" id="Vector_7" />
          <path d={svgPaths.p964f000} fill="url(#paint4_linear_0_299)" id="Vector_8" />
          <path d={svgPaths.p37d03e70} fill="white" id="Vector_9" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_299" x1="146.929" x2="315.214" y1="349.085" y2="162.207">
            <stop stopColor="#92278F" />
            <stop offset="0.5" stopColor="#3777BC" />
            <stop offset="1" stopColor="#00C0F3" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_299" x1="257.336" x2="475.6" y1="89.7012" y2="158.842">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_299" x1="106.981" x2="149.548" y1="218.549" y2="-6.41074">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_299" x1="221.221" x2="28.1982" y1="435.636" y2="312.485">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_0_299" x1="385.566" x2="333.719" y1="260.266" y2="483.276">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
  ...
  return (
    <div className="absolute inset-[0_0.12%_0_70.53%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" height="61.7004" preserveAspectRatio="none" viewBox="0 0 61.924 61.7004" width="61.924">
        <g id="Group">
          <path clipRule="evenodd" d={svgPaths.p2a0a4b00} fill="url(#paint0_linear_0_204)" fillRule="evenodd" id="Vector" />
          <path d={svgPaths.p336c1180} fill="url(#paint1_linear_0_204)" id="Vector_2" />
          <path d={svgPaths.p3f39c700} fill="white" id="Vector_3" />
          <path d={svgPaths.pa837700} fill="url(#paint2_linear_0_204)" id="Vector_4" />
          <path d={svgPaths.pa073800} fill="white" id="Vector_5" />
          <path d={svgPaths.p2528470} fill="url(#paint3_linear_0_204)" id="Vector_6" />
          <path d={svgPaths.p34308700} fill="white" id="Vector_7" />
          <path d={svgPaths.p10607800} fill="url(#paint4_linear_0_204)" id="Vector_8" />
          <path d={svgPaths.p3a474100} fill="white" id="Vector_9" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_204" x1="18.7211" x2="40.1405" y1="44.4355" y2="20.6294">
            <stop stopColor="#92278F" />
            <stop offset="0.5" stopColor="#3777BC" />
            <stop offset="1" stopColor="#00C0F3" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_204" x1="32.786" x2="60.5883" y1="11.4182" y2="20.2328">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_204" x1="13.6311" x2="19.0452" y1="27.8186" y2="-0.818489">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_204" x1="28.1841" x2="3.60729" y1="55.4526" y2="39.7578">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_0_204" x1="49.1217" x2="42.527" y1="33.1283" y2="61.518">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
...
function MaskGroup() {
  return (
    <div className="absolute contents left-[calc(8.33%+165px)] top-[892.42px]" data-name="Mask group">
      <div className="absolute bg-[#d9d9d9] h-[311.807px] left-[calc(16.67%+81.32px)] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-36.315px_55.724px] mask-size-[312.938px_311.807px] opacity-65 rounded-[15.027px] top-[836.7px] w-[239.177px]" style={{ maskImage: `url("${imgRectangle21939}")` }} />
    </div>
  );
}
...
function Objects() {
  return (
    <div className="absolute h-[141.503px] left-[calc(16.67%+128.9px)] top-[829.81px] w-[146.019px]" data-name="Objects">
      <svg className="absolute block inset-0 size-full" fill="none" height="141.503" preserveAspectRatio="none" viewBox="0 0 146.019 141.503" width="146.019">
        <g id="Objects">
          <path d={svgPaths.p35fc6780} fill="white" id="Vector" stroke="#009DC4" strokeWidth="1.6614" />
          <path d={svgPaths.p1cf2e100} fill="white" id="Vector_2" stroke="#009DC4" strokeWidth="1.6614" />
        </g>
      </svg>
    </div>
  );
...
function Group9() {
  return (
    <div className="absolute contents left-[calc(16.67%+128.9px)] top-[829.81px]">
      <Objects />
    </div>
  );
}
...
function Group2() {
  return (
    <div className="absolute inset-[56.93%_68.07%_41.19%_29.44%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" height="35.6359" preserveAspectRatio="none" viewBox="0 0 35.7655 35.6359" width="35.7655">
        <g id="Group">
          <path clipRule="evenodd" d={svgPaths.p25b30800} fill="url(#paint0_linear_0_437)" fillRule="evenodd" id="Vector" />
          <path d={svgPaths.p234d7d00} fill="url(#paint1_linear_0_437)" id="Vector_2" />
          <path d={svgPaths.p6b22500} fill="white" id="Vector_3" />
          <path d={svgPaths.pe89a600} fill="url(#paint2_linear_0_437)" id="Vector_4" />
          <path d={svgPaths.p20b30d80} fill="white" id="Vector_5" />
          <path d={svgPaths.p3a9f6790} fill="url(#paint3_linear_0_437)" id="Vector_6" />
          <path d={svgPaths.p2a5d6c00} fill="white" id="Vector_7" />
          <path d={svgPaths.p1cbd1c00} fill="url(#paint4_linear_0_437)" id="Vector_8" />
          <path d={svgPaths.p2e239600} fill="white" id="Vector_9" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_437" x1="10.8127" x2="23.1837" y1="25.6643" y2="11.9148">
            <stop stopColor="#92278F" />
            <stop offset="0.5" stopColor="#3777BC" />
            <stop offset="1" stopColor="#00C0F3" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_437" x1="18.9364" x2="34.9939" y1="6.59472" y2="11.6857">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_437" x1="7.87402" x2="11.001" y1="16.0668" y2="-0.47291">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_437" x1="16.2785" x2="2.08393" y1="32.0273" y2="22.9626">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_0_437" x1="28.3714" x2="24.5625" y1="19.1337" y2="35.5305">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
...
function MaskGroup1() {
  return (
    <div className="absolute contents left-[calc(8.33%+165px)] top-[1288.42px]" data-name="Mask group">
      <div className="absolute bg-[#d9d9d9] h-[311.807px] left-[calc(16.67%+81.32px)] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-36.315px_55.724px] mask-size-[312.938px_311.807px] opacity-65 rounded-[15.027px] top-[1232.7px] w-[239.177px]" style={{ maskImage: `url("${imgRectangle21940}")` }} />
    </div>
  );
}
...
function Objects1() {
  return (
    <div className="absolute h-[141.503px] left-[calc(16.67%+128.9px)] top-[1225.81px] w-[146.019px]" data-name="Objects">
      <svg className="absolute block inset-0 size-full" fill="none" height="141.503" preserveAspectRatio="none" viewBox="0 0 146.019 141.503" width="146.019">
        <g id="Objects">
          <path d={svgPaths.p35fc6780} fill="white" id="Vector" stroke="#009DC4" strokeWidth="1.6614" />
          <path d={svgPaths.p510a180} fill="white" id="Vector_2" stroke="#009DC4" strokeWidth="1.6614" />
        </g>
      </svg>
    </div>
  );
...
function Group10() {
  return (
    <div className="absolute contents left-[calc(16.67%+128.9px)] top-[1225.81px]">
      <Objects1 />
    </div>
  );
}
...
function Group3() {
  return (
    <div className="absolute inset-[77.87%_68.07%_20.25%_29.44%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" height="35.6359" preserveAspectRatio="none" viewBox="0 0 35.7655 35.6359" width="35.7655">
        <g id="Group">
          <path clipRule="evenodd" d={svgPaths.p25b30800} fill="url(#paint0_linear_0_172)" fillRule="evenodd" id="Vector" />
          <path d={svgPaths.p234d7d00} fill="url(#paint1_linear_0_172)" id="Vector_2" />
          <path d={svgPaths.p6b22500} fill="white" id="Vector_3" />
          <path d={svgPaths.pe89a600} fill="url(#paint2_linear_0_172)" id="Vector_4" />
          <path d={svgPaths.p20b30d80} fill="white" id="Vector_5" />
          <path d={svgPaths.p3a9f6790} fill="url(#paint3_linear_0_172)" id="Vector_6" />
          <path d={svgPaths.p2a5d6c00} fill="white" id="Vector_7" />
          <path d={svgPaths.p384ff580} fill="url(#paint4_linear_0_172)" id="Vector_8" />
          <path d={svgPaths.p2e239600} fill="white" id="Vector_9" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_172" x1="10.8127" x2="23.1837" y1="25.6643" y2="11.9148">
            <stop stopColor="#92278F" />
            <stop offset="0.5" stopColor="#3777BC" />
            <stop offset="1" stopColor="#00C0F3" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_172" x1="18.9364" x2="34.9939" y1="6.59472" y2="11.6857">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_172" x1="7.87402" x2="11.001" y1="16.0668" y2="-0.47291">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_172" x1="16.2785" x2="2.08393" y1="32.0273" y2="22.9626">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_0_172" x1="28.3714" x2="24.5625" y1="19.1337" y2="35.5305">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
...
function MaskGroup2() {
  return (
    <div className="absolute contents left-[calc(33.33%+86.24px)] top-[892.42px]" data-name="Mask group">
      <div className="absolute bg-[#d9d9d9] h-[311.807px] left-[calc(33.33%+122.56px)] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-36.315px_55.724px] mask-size-[312.938px_311.807px] opacity-65 rounded-[15.027px] top-[836.7px] w-[239.177px]" style={{ maskImage: `url("${imgRectangle21941}")` }} />
    </div>
  );
}
...
function Objects2() {
  return (
    <div className="absolute h-[141.503px] left-[calc(41.67%+50.14px)] top-[829.81px] w-[146.019px]" data-name="Objects">
      <svg className="absolute block inset-0 size-full" fill="none" height="141.503" preserveAspectRatio="none" viewBox="0 0 146.019 141.503" width="146.019">
        <g id="Objects">
          <path d={svgPaths.p13fe6810} fill="white" id="Vector" stroke="#009DC4" strokeWidth="1.6614" />
          <path d={svgPaths.p2319d580} fill="white" id="Vector_2" stroke="#009DC4" strokeWidth="1.6614" />
        </g>
      </svg>
    </div>
  );
...
function Group11() {
  return (
    <div className="absolute contents left-[calc(41.67%+50.14px)] top-[829.81px]">
      <Objects2 />
    </div>
  );
}
...
function Group4() {
  return (
    <div className="absolute inset-[56.93%_48.54%_41.19%_48.97%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" height="35.6358" preserveAspectRatio="none" viewBox="0 0 35.7655 35.6358" width="35.7655">
        <g id="Group">
          <path clipRule="evenodd" d={svgPaths.p2f361b80} fill="url(#paint0_linear_0_159)" fillRule="evenodd" id="Vector" />
          <path d={svgPaths.p3b544c00} fill="url(#paint1_linear_0_159)" id="Vector_2" />
          <path d={svgPaths.p6b22500} fill="white" id="Vector_3" />
          <path d={svgPaths.p28a02100} fill="url(#paint2_linear_0_159)" id="Vector_4" />
          <path d={svgPaths.p1de57c00} fill="white" id="Vector_5" />
          <path d={svgPaths.p2180d000} fill="url(#paint3_linear_0_159)" id="Vector_6" />
          <path d={svgPaths.p1b4fa700} fill="white" id="Vector_7" />
          <path d={svgPaths.p5f5d580} fill="url(#paint4_linear_0_159)" id="Vector_8" />
          <path d={svgPaths.p2e239600} fill="white" id="Vector_9" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_159" x1="10.8129" x2="23.1839" y1="25.6643" y2="11.9148">
            <stop stopColor="#92278F" />
            <stop offset="0.5" stopColor="#3777BC" />
            <stop offset="1" stopColor="#00C0F3" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_159" x1="18.9368" x2="34.9944" y1="6.59472" y2="11.6857">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_159" x1="7.87416" x2="11.0012" y1="16.0668" y2="-0.472896">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_159" x1="16.2785" x2="2.08392" y1="32.0273" y2="22.9626">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_0_159" x1="28.3714" x2="24.5625" y1="19.1337" y2="35.5305">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
...
function MaskGroup3() {
  return (
    <div className="absolute contents left-[calc(33.33%+86.24px)] top-[1288.42px]" data-name="Mask group">
      <div className="absolute bg-[#d9d9d9] h-[311.807px] left-[calc(33.33%+122.56px)] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-36.315px_55.724px] mask-size-[312.938px_311.807px] opacity-65 rounded-[15.027px] top-[1232.7px] w-[239.177px]" style={{ maskImage: `url("${imgRectangle21942}")` }} />
    </div>
  );
}
...
function Objects3() {
  return (
    <div className="absolute h-[141.503px] left-[calc(41.67%+50.14px)] top-[1225.81px] w-[146.019px]" data-name="Objects">
      <svg className="absolute block inset-0 size-full" fill="none" height="141.503" preserveAspectRatio="none" viewBox="0 0 146.019 141.503" width="146.019">
        <g id="Objects">
          <path d={svgPaths.p13fe6810} fill="white" id="Vector" stroke="#009DC4" strokeWidth="1.6614" />
          <path d={svgPaths.p2319d580} fill="white" id="Vector_2" stroke="#009DC4" strokeWidth="1.6614" />
...
function Group12() {
  return (
    <div className="absolute contents left-[calc(41.67%+50.14px)] top-[1225.81px]">
      <Objects3 />
    </div>
  );
}
...
function Group5() {
  return (
    <div className="absolute inset-[77.87%_48.54%_20.25%_48.97%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" height="35.6358" preserveAspectRatio="none" viewBox="0 0 35.7655 35.6358" width="35.7655">
        <g id="Group">
          <path clipRule="evenodd" d={svgPaths.p2f361b80} fill="url(#paint0_linear_0_149)" fillRule="evenodd" id="Vector" />
          <path d={svgPaths.p3b544c00} fill="url(#paint1_linear_0_149)" id="Vector_2" />
          <path d={svgPaths.p2c97c380} fill="white" id="Vector_3" />
          <path d={svgPaths.p28a02100} fill="url(#paint2_linear_0_149)" id="Vector_4" />
          <path d={svgPaths.p705c080} fill="white" id="Vector_5" />
          <path d={svgPaths.p2180d000} fill="url(#paint3_linear_0_149)" id="Vector_6" />
          <path d={svgPaths.p1b4fa700} fill="white" id="Vector_7" />
          <path d={svgPaths.p5f5d580} fill="url(#paint4_linear_0_149)" id="Vector_8" />
          <path d={svgPaths.p2e239600} fill="white" id="Vector_9" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_149" x1="10.8129" x2="23.1839" y1="25.6643" y2="11.9148">
            <stop stopColor="#92278F" />
            <stop offset="0.5" stopColor="#3777BC" />
            <stop offset="1" stopColor="#00C0F3" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_149" x1="18.9368" x2="34.9944" y1="6.59472" y2="11.6857">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_149" x1="7.87416" x2="11.0012" y1="16.0668" y2="-0.472896">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_149" x1="16.2785" x2="2.08392" y1="32.0273" y2="22.9626">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_0_149" x1="28.3714" x2="24.5625" y1="19.1337" y2="35.5305">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
...
function MaskGroup4() {
  return (
    <div className="absolute contents left-[calc(58.33%+6.63px)] top-[892.42px]" data-name="Mask group">
      <div className="absolute bg-[#d9d9d9] h-[311.807px] left-[calc(58.33%+42.94px)] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-36.315px_55.724px] mask-size-[312.938px_311.807px] opacity-65 rounded-[15.027px] top-[836.7px] w-[239.177px]" style={{ maskImage: `url("${imgRectangle21943}")` }} />
    </div>
  );
}
...
function Objects4() {
  return (
    <div className="absolute h-[141.503px] left-[calc(66.67%-29.47px)] top-[829.81px] w-[146.019px]" data-name="Objects">
      <svg className="absolute block inset-0 size-full" fill="none" height="141.503" preserveAspectRatio="none" viewBox="0 0 146.019 141.503" width="146.019">
        <g id="Objects">
          <path d={svgPaths.p3e64f200} fill="white" id="Vector" stroke="#009DC4" strokeWidth="1.6614" />
          <path d={svgPaths.pebe8300} fill="white" id="Vector_2" stroke="#009DC4" strokeWidth="1.6614" />
        </g>
      </svg>
    </div>
  );
...
function Group13() {
  return (
    <div className="absolute contents left-[calc(66.67%-29.47px)] top-[829.81px]">
      <Objects4 />
    </div>
  );
}
...
function Group6() {
  return (
    <div className="absolute inset-[56.93%_29.07%_41.19%_68.45%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" height="35.6358" preserveAspectRatio="none" viewBox="0 0 35.7655 35.6358" width="35.7655">
        <g id="Group">
          <path clipRule="evenodd" d={svgPaths.p3b50c380} fill="url(#paint0_linear_0_321)" fillRule="evenodd" id="Vector" />
          <path d={svgPaths.p3b544c00} fill="url(#paint1_linear_0_321)" id="Vector_2" />
          <path d={svgPaths.p6b22500} fill="white" id="Vector_3" />
          <path d={svgPaths.p28a02100} fill="url(#paint2_linear_0_321)" id="Vector_4" />
          <path d={svgPaths.p1de57c00} fill="white" id="Vector_5" />
          <path d={svgPaths.p2180d000} fill="url(#paint3_linear_0_321)" id="Vector_6" />
          <path d={svgPaths.p1b4fa700} fill="white" id="Vector_7" />
          <path d={svgPaths.p217d4100} fill="url(#paint4_linear_0_321)" id="Vector_8" />
          <path d={svgPaths.p2e239600} fill="white" id="Vector_9" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_321" x1="10.8129" x2="23.1839" y1="25.6643" y2="11.9148">
            <stop stopColor="#92278F" />
            <stop offset="0.5" stopColor="#3777BC" />
            <stop offset="1" stopColor="#00C0F3" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_321" x1="18.9368" x2="34.9944" y1="6.59472" y2="11.6857">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_321" x1="7.87416" x2="11.0012" y1="16.0668" y2="-0.472896">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_321" x1="16.2785" x2="2.08392" y1="32.0273" y2="22.9626">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_0_321" x1="28.3713" x2="24.5625" y1="19.1337" y2="35.5305">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
...
function MaskGroup5() {
  return (
    <div className="absolute contents left-[calc(58.33%+6.63px)] top-[1288.42px]" data-name="Mask group">
      <div className="absolute bg-[#d9d9d9] h-[311.807px] left-[calc(58.33%+42.94px)] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-36.315px_55.724px] mask-size-[312.938px_311.807px] opacity-65 rounded-[15.027px] top-[1232.7px] w-[239.177px]" style={{ maskImage: `url("${imgRectangle21944}")` }} />
    </div>
  );
}
...
function Objects5() {
  return (
    <div className="absolute h-[141.503px] left-[calc(66.67%-29.47px)] top-[1225.81px] w-[146.019px]" data-name="Objects">
      <svg className="absolute block inset-0 size-full" fill="none" height="141.503" preserveAspectRatio="none" viewBox="0 0 146.019 141.503" width="146.019">
        <g id="Objects">
          <path d={svgPaths.p3e64f200} fill="white" id="Vector" stroke="#009DC4" strokeWidth="1.6614" />
          <path d={svgPaths.pebe8300} fill="white" id="Vector_2" stroke="#009DC4" strokeWidth="1.6614" />
...
function Group14() {
  return (
    <div className="absolute contents left-[calc(66.67%-29.47px)] top-[1225.81px]">
      <Objects5 />
    </div>
  );
}
...
function Group7() {
  return (
    <div className="absolute inset-[77.87%_29.07%_20.25%_68.45%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" height="35.6358" preserveAspectRatio="none" viewBox="0 0 35.7655 35.6358" width="35.7655">
        <g id="Group">
          <path clipRule="evenodd" d={svgPaths.p3b50c380} fill="url(#paint0_linear_0_117)" fillRule="evenodd" id="Vector" />
          <path d={svgPaths.p3b544c00} fill="url(#paint1_linear_0_117)" id="Vector_2" />
          <path d={svgPaths.p2c97c380} fill="white" id="Vector_3" />
          <path d={svgPaths.p28a02100} fill="url(#paint2_linear_0_117)" id="Vector_4" />
          <path d={svgPaths.p705c080} fill="white" id="Vector_5" />
          <path d={svgPaths.p2180d000} fill="url(#paint3_linear_0_117)" id="Vector_6" />
          <path d={svgPaths.p1b4fa700} fill="white" id="Vector_7" />
          <path d={svgPaths.p217d4100} fill="url(#paint4_linear_0_117)" id="Vector_8" />
          <path d={svgPaths.p2e239600} fill="white" id="Vector_9" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_117" x1="10.8129" x2="23.1839" y1="25.6643" y2="11.9148">
            <stop stopColor="#92278F" />
            <stop offset="0.5" stopColor="#3777BC" />
            <stop offset="1" stopColor="#00C0F3" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_117" x1="18.9368" x2="34.9944" y1="6.59472" y2="11.6857">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_117" x1="7.87416" x2="11.0012" y1="16.0668" y2="-0.472896">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_117" x1="16.2785" x2="2.08392" y1="32.0273" y2="22.9626">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_0_117" x1="28.3713" x2="24.5625" y1="19.1337" y2="35.5305">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
...
function LandingPage() {
  ...
  return (
    <div className="relative bg-white h-[1891px] mx-auto overflow-clip w-[1440px]" data-name="Landing Page">
      <Header />
      <Layer />
      <p className="-translate-x-full [word-break:break-word] absolute bottom-[80.75%] font-['Hacen_Casablanca:Regular',sans-serif] leading-[58px] left-[calc(25%+245px)] not-italic text-[55px] text-right text-white top-[16.18%] w-[404px]" dir="auto">
        {pol.heroTitle}
      </p>
      ...
      <div className="absolute border border-solid border-white h-[411px] left-[100px] rounded-[30px] top-[205px] w-[921px]" style={{ clipPath: "polygon(0 0, 680px 0, 680px 20px, 720px 20px, 720px 0, 100% 0, 100% 100%, 0 100%)" }} />
