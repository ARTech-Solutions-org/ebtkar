...
function LandingPage() {
  ...
  return (
    <div className="relative bg-white h-[1891px] mx-auto overflow-clip w-[1440px]" data-name="Landing Page">
      <Header />
      <Layer />
      <p className="-translate-x-full [word-break:break-word] absolute bottom-[80.75%] font-['Hacen_Casablanca:Regular',sans-serif] leading-[58px] left-[calc(25%+245px)] not-italic text-[55px] text-right text-white top-[16.18%] w-[404px] animate-hero-reveal" dir="auto">
        {pol.heroTitle}
      </p>
      ...
      <div className="absolute h-[583px] left-[calc(50%+10px)] top-[124px] w-[608px] animate-hero-image" data-name="Layer 1 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[107.72%] left-[-0.06%] max-w-none top-0 w-[100.11%]" src={pol.heroImage || imgLayer11} />
        </div>
      </div>
