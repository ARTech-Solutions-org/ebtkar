              ...
              <div className="relative size-full">
                <svg className="absolute block inset-0 size-full" fill="none" height="66" preserveAspectRatio="none" viewBox="0 0 66 66" width="66">
                  <g id="Group 1">
                    ...
                    <g id="arrow_upward">
                      <mask height="30" id="mask0_0_301" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="30" x="18" y="18">
...
function LandingPage() {
  ...
  return (
    <div className="relative bg-white h-[2765px] mx-auto overflow-clip w-[1440px]" data-name="Landing Page">
      ...
      <div className="absolute border-3 border-[#009dc4] border-solid h-[836px] left-[calc(8.33%+85px)] rounded-[30px] top-[1593px] w-[1030px]" />
    </div>
  );
}
