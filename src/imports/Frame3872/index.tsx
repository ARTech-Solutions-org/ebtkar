              ...
              <div className="relative size-full">
                <svg className="absolute block inset-0 size-full" fill="none" height="66" preserveAspectRatio="none" viewBox="0 0 66 66" width="66">
                  <g id="Group 1">
                    ...
                    <g id="arrow_upward">
                      <mask height="30" id="mask0_0_partners" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="30" x="18" y="18">
...
function LandingPage() {
  ...
  const sectionImg = p.sectionImage || imgSectionDefault;
  ...
  return (
    <div className="relative bg-white h-[1598px] mx-auto overflow-clip w-[1440px]" data-name="Landing Page">
      ...
      <div className="absolute h-[349px] left-[calc(8.33%+85px)] rounded-[30px] top-[790px] w-[621px]" data-name="Partners Image">
        <img alt="الشركاء" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[30px] size-full" src={sectionImg} />
      </div>
