              ...
              <div className="relative size-full">
                <svg className="absolute block inset-0 size-full" fill="none" height="66" preserveAspectRatio="none" viewBox="0 0 66 66" width="66">
                  <g id="Group 1">
                    ...
                    <g id="arrow_upward">
                      <mask height="30" id="mask0_0_247" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="30" x="18" y="18">
...
function Bg() {
  return (
    <div className="absolute contents left-[-8px] top-0" data-name="bg">
      ...
      <Group2 />
      <div className="absolute h-0 left-[calc(41.67%+84px)] top-[101px] w-[56px]">
        <div className="absolute inset-[-0.5px_0]">
          <svg className="block size-full" fill="none" height="1" preserveAspectRatio="none" viewBox="0 0 56 1" width="56">
            <path d="M0 0.5H56" id="Vector 16" stroke="white" />
          </svg>
        </div>
      </div>
    </div>
...
function LandingPage() {
  return (
    <div className="relative bg-white h-[2602px] mx-auto overflow-clip w-[1440px]" data-name="Landing Page">
      <Header />
      <Layer />
      <p className="-translate-x-full [word-break:break-word] absolute bottom-[87.93%] font-['Hacen_Casablanca:Regular',sans-serif] leading-[58px] left-[calc(33.33%+230px)] not-italic text-[55px] text-right text-white top-[9.84%] w-[404px]" dir="auto">
        الشـــركاء...
      </p>
      ...
      <div className="absolute bg-white border-3 border-[#009dc4] border-solid h-[758px] left-[calc(8.33%+85px)] rounded-[30px] top-[823px] w-[1030px]" />
      <div className="absolute bg-white border-3 border-[#009dc4] border-solid h-[673px] left-[calc(8.33%+85px)] rounded-[30px] top-[1609px] w-[1030px]" />
      <Frame1 />
      <Frame2 />
      <Group4 />
      <Group5 />
