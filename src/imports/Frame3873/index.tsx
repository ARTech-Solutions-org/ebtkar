import svgPaths from "./svg-hloju71tj7";
        ...
        <div className="absolute inset-[41.1%_65.32%_27.04%_14.67%] overflow-clip" data-name="Layer_1">
          ...
          <div className="absolute inset-[0_0.12%_0_70.53%]" data-name="Group">
            <svg className="absolute block inset-0 size-full" fill="none" height="85.3864" preserveAspectRatio="none" viewBox="0 0 85.6964 85.3864" width="85.6964">
              <g id="Group">
                <path clipRule="evenodd" d={svgPaths.p1191e780} fill="url(#paint0_linear_0_159)" fillRule="evenodd" id="Vector" />
                <path d={svgPaths.p37de6300} fill="url(#paint1_linear_0_159)" id="Vector_2" />
                <path d={svgPaths.p1ee50c00} fill="white" id="Vector_3" />
                <path d={svgPaths.p35d15700} fill="url(#paint2_linear_0_159)" id="Vector_4" />
                <path d={svgPaths.pa998900} fill="white" id="Vector_5" />
                <path d={svgPaths.p1e886100} fill="url(#paint3_linear_0_159)" id="Vector_6" />
                <path d={svgPaths.p2b6c6cf0} fill="white" id="Vector_7" />
                <path d={svgPaths.p148cbb00} fill="url(#paint4_linear_0_159)" id="Vector_8" />
                <path d={svgPaths.p1da39e80} fill="white" id="Vector_9" />
              </g>
              <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_159" x1="25.9072" x2="55.5492" y1="61.4936" y2="28.5487">
                  <stop stopColor="#92278F" />
                  <stop offset="0.5" stopColor="#3777BC" />
                  <stop offset="1" stopColor="#00C0F3" />
                </linearGradient>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_159" x1="45.3728" x2="83.848" y1="15.8015" y2="27.9999">
                  <stop stopColor="white" stopOpacity="0" />
                  <stop offset="0.51" stopColor="#5C2D91" />
                  <stop offset="1" stopColor="#00AEEF" />
                </linearGradient>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_159" x1="18.8632" x2="26.3558" y1="38.4981" y2="-1.13239">
                  <stop stopColor="white" stopOpacity="0" />
                  <stop offset="0.51" stopColor="#5C2D91" />
                  <stop offset="1" stopColor="#00AEEF" />
                </linearGradient>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_159" x1="39.0032" x2="4.99172" y1="76.74" y2="55.0202">
                  <stop stopColor="white" stopOpacity="0" />
                  <stop offset="0.51" stopColor="#5C2D91" />
                  <stop offset="1" stopColor="#00AEEF" />
                </linearGradient>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_0_159" x1="67.9794" x2="58.8531" y1="45.8459" y2="85.134">
                  <stop stopColor="white" stopOpacity="0" />
                  <stop offset="0.51" stopColor="#5C2D91" />
                  <stop offset="1" stopColor="#00AEEF" />
                </linearGradient>
  ...
  return (
    <div className="absolute h-[484.718px] left-[calc(50%+87.47px)] opacity-25 top-[151px] w-[486.067px]" data-name="Isolation_Mode">
      <svg className="absolute block inset-0 size-full" fill="none" height="484.718" preserveAspectRatio="none" viewBox="0 0 486.067 484.718" width="486.067">
        <g clipPath="url(#clip0_0_238)" id="Isolation_Mode">
          <path clipRule="evenodd" d={svgPaths.peb53500} fill="url(#paint0_linear_0_238)" fillRule="evenodd" id="Vector" />
          <path d={svgPaths.p30c6e400} fill="url(#paint1_linear_0_238)" id="Vector_2" />
          <path d={svgPaths.p277ccc00} fill="white" id="Vector_3" />
          <path d={svgPaths.p2a8fec80} fill="url(#paint2_linear_0_238)" id="Vector_4" />
          <path d={svgPaths.p21358600} fill="white" id="Vector_5" />
          <path d={svgPaths.p2a0ab200} fill="url(#paint3_linear_0_238)" id="Vector_6" />
          <path d={svgPaths.p3439d200} fill="white" id="Vector_7" />
          <path d={svgPaths.p964f000} fill="url(#paint4_linear_0_238)" id="Vector_8" />
          <path d={svgPaths.p37d03e70} fill="white" id="Vector_9" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_238" x1="146.929" x2="315.214" y1="349.085" y2="162.207">
            <stop stopColor="#92278F" />
            <stop offset="0.5" stopColor="#3777BC" />
            <stop offset="1" stopColor="#00C0F3" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_238" x1="257.336" x2="475.6" y1="89.7012" y2="158.842">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_238" x1="106.981" x2="149.548" y1="218.549" y2="-6.41074">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_238" x1="221.221" x2="28.1982" y1="435.636" y2="312.485">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_0_238" x1="385.566" x2="333.719" y1="260.266" y2="483.276">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
  ...
  return (
    <div className="absolute inset-[0_0.12%_0_70.53%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" height="61.7004" preserveAspectRatio="none" viewBox="0 0 61.924 61.7004" width="61.924">
        <g id="Group">
          <path clipRule="evenodd" d={svgPaths.p2a0a4b00} fill="url(#paint0_linear_0_149)" fillRule="evenodd" id="Vector" />
          <path d={svgPaths.p336c1180} fill="url(#paint1_linear_0_149)" id="Vector_2" />
          <path d={svgPaths.p3f39c700} fill="white" id="Vector_3" />
          <path d={svgPaths.pb431580} fill="url(#paint2_linear_0_149)" id="Vector_4" />
          <path d={svgPaths.pa073800} fill="white" id="Vector_5" />
          <path d={svgPaths.p2528470} fill="url(#paint3_linear_0_149)" id="Vector_6" />
          <path d={svgPaths.p34308700} fill="white" id="Vector_7" />
          <path d={svgPaths.p10607800} fill="url(#paint4_linear_0_149)" id="Vector_8" />
          <path d={svgPaths.p3a474100} fill="white" id="Vector_9" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_149" x1="18.7211" x2="40.1405" y1="44.4355" y2="20.6294">
            <stop stopColor="#92278F" />
            <stop offset="0.5" stopColor="#3777BC" />
            <stop offset="1" stopColor="#00C0F3" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_149" x1="32.786" x2="60.5883" y1="11.4182" y2="20.2328">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_149" x1="13.6311" x2="19.0452" y1="27.8186" y2="-0.818491">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_149" x1="28.1841" x2="3.60729" y1="55.4526" y2="39.7578">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_0_149" x1="49.1217" x2="42.527" y1="33.1283" y2="61.518">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
...
function IsolationMode1() {
  return (
    <div className="absolute h-[229.8px] left-[calc(16.67%+74.76px)] top-[1100px] w-[176.225px] reveal-on-scroll" data-name="Isolation_Mode">
      <svg className="absolute block inset-0 size-full" fill="none" height="229.8" preserveAspectRatio="none" viewBox="0 0 176.225 229.8" width="176.225">
        <g clipPath="url(#clip0_0_146)" id="Isolation_Mode">
          <path d={svgPaths.p1d4a9b00} fill="#009DC4" id="Vector" />
          <path d={svgPaths.p39db1180} fill="#009DC4" id="Vector_2" />
        </g>
        <defs>
...
function Layer1() {
  return (
    <div className="absolute h-[80px] left-[calc(16.67%+128px)] top-[1160px] w-[84px]" data-name="Layer_1">
      <svg className="absolute block inset-0 size-full" fill="none" height="80" preserveAspectRatio="none" viewBox="0 0 84 80" width="84">
        <g clipPath="url(#clip0_0_141)" id="Layer_1">
          <path d={svgPaths.p93a0500} fill="black" id="Vector" />
          <path d={svgPaths.p20613300} fill="black" id="Vector_2" />
          <path d={svgPaths.p2594e480} fill="black" id="Vector_3" />
        </g>
        <defs>
...
function Group3() {
  return (
    <div className="absolute contents left-[calc(16.67%+74.76px)] top-[1100px]">
      <IsolationMode1 />
      <Layer1 />
    </div>
  );
...
function IsolationMode2() {
  return (
    <div className="absolute h-[229.8px] left-[calc(33.33%+46.76px)] top-[1100px] w-[176.225px] reveal-on-scroll reveal-delay-100" data-name="Isolation_Mode">
      <svg className="absolute block inset-0 size-full" fill="none" height="229.8" preserveAspectRatio="none" viewBox="0 0 176.225 229.8" width="176.225">
        <g clipPath="url(#clip0_0_146)" id="Isolation_Mode">
          <path d={svgPaths.p1d4a9b00} fill="#009DC4" id="Vector" />
          <path d={svgPaths.p39db1180} fill="#009DC4" id="Vector_2" />
...
function Layer2() {
  return (
    <div className="absolute h-[73.76px] left-[calc(33.33%+95px)] top-[1167px] w-[79.47px]" data-name="Layer_1">
      <svg className="absolute block inset-0 size-full" fill="none" height="73.76" preserveAspectRatio="none" viewBox="0 0 79.47 73.76" width="79.47">
        <g clipPath="url(#clip0_0_306)" id="Layer_1">
          <path d={svgPaths.p16a0b600} fill="black" id="Vector" />
          <path d={svgPaths.p20cd5c00} fill="black" id="Vector_2" />
          <path d={svgPaths.p2a768a00} fill="black" id="Vector_3" />
          <path d={svgPaths.pe727d00} fill="black" id="Vector_4" />
          <path d={svgPaths.p1235500} fill="black" id="Vector_5" />
          <path d={svgPaths.p6458a00} fill="black" id="Vector_6" />
          <path d={svgPaths.p11292500} fill="black" id="Vector_7" />
          <path d={svgPaths.p314b91c0} fill="black" id="Vector_8" />
          <path d={svgPaths.p4fada80} fill="black" id="Vector_9" />
          <path d={svgPaths.p34eff800} fill="black" id="Vector_10" />
          <path d={svgPaths.p12a22300} fill="black" id="Vector_11" />
        </g>
        <defs>
          <clipPath id="clip0_0_306">
            <rect fill="white" height="73.76" width="79.47" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function Group4() {
  return (
    <div className="absolute contents left-[calc(33.33%+46.76px)] top-[1100px]">
      <IsolationMode2 />
      <Layer2 />
    </div>
  );
...
function IsolationMode3() {
  return (
    <div className="absolute h-[229.8px] left-[calc(33.33%+46.76px)] top-[1473px] w-[176.225px] reveal-on-scroll" data-name="Isolation_Mode">
      <svg className="absolute block inset-0 size-full" fill="none" height="229.8" preserveAspectRatio="none" viewBox="0 0 176.225 229.8" width="176.225">
        <g clipPath="url(#clip0_0_221)" id="Isolation_Mode">
          <path d={svgPaths.p1d4a9b00} fill="#009DC4" id="Vector" />
          <path d={svgPaths.p1447b900} fill="#009DC4" id="Vector_2" />
        </g>
        <defs>
...
function Layer3() {
  return (
    <div className="absolute left-[calc(33.33%+101px)] size-[77px] top-[1540px]" data-name="Layer_1">
      <svg className="absolute block inset-0 size-full" fill="none" height="77" preserveAspectRatio="none" viewBox="0 0 77 77" width="77">
        <g clipPath="url(#clip0_0_132)" id="Layer_1">
          <path d={svgPaths.p21d41780} fill="black" id="Vector" />
          <path d={svgPaths.p23bd4580} fill="black" id="Vector_2" />
          <path d={svgPaths.p3ce7cd00} fill="black" id="Vector_3" />
          <path d={svgPaths.p25bff800} fill="black" id="Vector_4" />
          <path d={svgPaths.p1671be00} fill="black" id="Vector_5" />
          <path d={svgPaths.p136c5700} fill="black" id="Vector_6" />
          <path d={svgPaths.p3c0b3800} fill="black" id="Vector_7" />
          <path d={svgPaths.p38a0500} fill="black" id="Vector_8" />
        </g>
        <defs>
...
function Group5() {
  return (
    <div className="absolute contents left-[calc(33.33%+46.76px)] top-[1473px]">
      <IsolationMode3 />
      <Layer3 />
    </div>
  );
...
function IsolationMode4() {
  return (
    <div className="absolute h-[229.8px] left-[calc(50%+18.76px)] top-[1100px] w-[176.225px] reveal-on-scroll reveal-delay-200" data-name="Isolation_Mode">
      <svg className="absolute block inset-0 size-full" fill="none" height="229.8" preserveAspectRatio="none" viewBox="0 0 176.225 229.8" width="176.225">
        <g clipPath="url(#clip0_0_146)" id="Isolation_Mode">
          <path d={svgPaths.p1d4a9b00} fill="#009DC4" id="Vector" />
          <path d={svgPaths.p39db1180} fill="#009DC4" id="Vector_2" />
...
function Layer4() {
  return (
    <div className="absolute h-[72.34px] left-[calc(50%+68px)] top-[1171px] w-[77.55px]" data-name="Layer_1">
      <svg className="absolute block inset-0 size-full" fill="none" height="72.34" preserveAspectRatio="none" viewBox="0 0 77.55 72.34" width="77.55">
        <g clipPath="url(#clip0_0_126)" id="Layer_1">
          <path d={svgPaths.p2db7e600} fill="black" id="Vector" />
          <path d={svgPaths.p5334f00} fill="black" id="Vector_2" />
          <path d={svgPaths.p16617900} fill="black" id="Vector_3" />
          <path d={svgPaths.p14403d80} fill="black" id="Vector_4" />
          <path d={svgPaths.p1c631000} fill="black" id="Vector_5" />
        </g>
        <defs>
          <clipPath id="clip0_0_126">
            <rect fill="white" height="72.34" width="77.55" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function Group6() {
  return (
    <div className="absolute contents left-[calc(50%+18.76px)] top-[1100px]">
      <IsolationMode4 />
      <Layer4 />
    </div>
  );
...
function IsolationMode5() {
  return (
    <div className="absolute h-[229.8px] left-[calc(50%+18.76px)] top-[1473px] w-[176.225px] reveal-on-scroll reveal-delay-100" data-name="Isolation_Mode">
      <svg className="absolute block inset-0 size-full" fill="none" height="229.8" preserveAspectRatio="none" viewBox="0 0 176.225 229.8" width="176.225">
        <g clipPath="url(#clip0_0_221)" id="Isolation_Mode">
          <path d={svgPaths.p1d4a9b00} fill="#009DC4" id="Vector" />
          <path d={svgPaths.p1447b900} fill="#009DC4" id="Vector_2" />
...
function Layer5() {
  return (
    <div className="absolute h-[65px] left-[calc(50%+68px)] top-[1542px] w-[78px]" data-name="Layer_1">
      <svg className="absolute block inset-0 size-full" fill="none" height="65" preserveAspectRatio="none" viewBox="0 0 78 65" width="78">
        <g clipPath="url(#clip0_0_108)" id="Layer_1">
          <path d={svgPaths.p20986480} fill="black" id="Vector" />
          <path d={svgPaths.p1f7e5a80} fill="black" id="Vector_2" />
          <path d={svgPaths.p101a7000} fill="black" id="Vector_3" />
          <path d={svgPaths.p1b8a5b80} fill="black" id="Vector_4" />
          <path d={svgPaths.p10974200} fill="black" id="Vector_5" />
          <path d={svgPaths.p6487800} fill="black" id="Vector_6" />
          <path d={svgPaths.p22117000} fill="black" id="Vector_7" />
        </g>
        <defs>
          <clipPath id="clip0_0_108">
            <rect fill="white" height="65" width="78" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function Group8() {
  return (
    <div className="absolute contents left-[calc(50%+18.76px)] top-[1473px]">
      <IsolationMode5 />
      <Layer5 />
    </div>
  );
...
function IsolationMode6() {
  return (
    <div className="absolute h-[229.8px] left-[calc(66.67%-12.24px)] top-[1100px] w-[176.225px] reveal-on-scroll reveal-delay-300" data-name="Isolation_Mode">
      <svg className="absolute block inset-0 size-full" fill="none" height="229.8" preserveAspectRatio="none" viewBox="0 0 176.225 229.8" width="176.225">
        <g clipPath="url(#clip0_0_146)" id="Isolation_Mode">
          <path d={svgPaths.p1d4a9b00} fill="#009DC4" id="Vector" />
          <path d={svgPaths.p39db1180} fill="#009DC4" id="Vector_2" />
...
function Layer6() {
  return (
    <div className="absolute h-[82.21px] left-[calc(66.67%+36px)] top-[1166px] w-[80.22px]" data-name="Layer_1">
      <svg className="absolute block inset-0 size-full" fill="none" height="82.21" preserveAspectRatio="none" viewBox="0 0 80.22 82.21" width="80.22">
        <g clipPath="url(#clip0_0_227)" id="Layer_1">
          <path d={svgPaths.p3602c100} fill="black" id="Vector" />
          <path d={svgPaths.p29cd7b00} fill="black" id="Vector_2" />
          <path d={svgPaths.pf0b9b72} fill="black" id="Vector_3" />
          <path d={svgPaths.pb142100} fill="black" id="Vector_4" />
          <path d={svgPaths.p12fb2770} fill="black" id="Vector_5" />
          <path d={svgPaths.p29ecc700} fill="black" id="Vector_6" />
          <path d={svgPaths.p98f4d00} fill="black" id="Vector_7" />
          <path d={svgPaths.p177046f0} fill="black" id="Vector_8" />
        </g>
        <defs>
          <clipPath id="clip0_0_227">
            <rect fill="white" height="82.21" width="80.22" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function Group9() {
  return (
    <div className="absolute contents left-[calc(66.67%-12.24px)] top-[1100px]">
      <IsolationMode6 />
      <Layer6 />
    </div>
  );
...
function LandingPage() {
  ...
  return (
    <div className="relative bg-white h-[2134px] mx-auto overflow-clip w-[1440px]" data-name="Landing Page">
      ...
      <div className="absolute bg-white border-3 border-[#009dc4] border-solid h-[236px] left-[calc(8.33%+85px)] rounded-[30px] top-[823px] w-[1030px] reveal-on-scroll card-hover-fx" />
      <p className="-translate-x-full [word-break:break-word] absolute font-['Hacen_Casablanca:Regular',sans-serif] leading-[54px] left-[calc(70.83%+165px)] not-italic text-[#009dc4] text-[55px] text-right top-[867px] w-[406px] reveal-on-scroll" dir="auto">
        {im.methodologyTitle}
      </p>
      <p className="-translate-x-full [word-break:break-word] absolute font-['Hacen_Casablanca_Light:Regular',sans-serif] leading-[30px] left-[calc(8.33%+1065px)] not-italic text-[#6e6e6e] text-[28px] text-right top-[933px] w-[928px] reveal-on-scroll" dir="auto">
        {im.methodologyBody}
      </p>
      <Group7 />
      <Group10 />
