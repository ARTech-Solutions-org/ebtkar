import svgPaths from "./svg-z1bkm9c8xz";
import { useNavigate } from "react-router";
import { NavigationBar } from "../../app/components/NavigationBar";
import imgLayer11 from "./922ea633b05e4bd1260330b71876671f04ddc610.png";
import imgChatGptImageJul272026At033922Pm1 from "./4164b668da429299a37372b9cb698a5f252e83bb.png";
import { useContent } from "../../cms/ContentContext";
import imgChatGptImageJul272026At034019Pm1 from "./6d2209c15a5e7d5e136350e3f13f00be32bdc75a.png";
import imgChatGptImageJul272026At034721Pm1 from "./870abc3e7632425e016d6a707bfdeb1a068821cc.png";
import imgChatGptImageJul272026At034858Pm1 from "./8412212911617701aefd6b50b2e1cc975742a84c.png";
        ...
        <div className="absolute inset-[41.1%_65.32%_27.04%_14.67%] overflow-clip" data-name="Layer_1">
          ...
          <div className="absolute inset-[0_0.12%_0_70.53%]" data-name="Group">
            <svg className="absolute block inset-0 size-full" fill="none" height="85.3862" preserveAspectRatio="none" viewBox="0 0 85.6964 85.3862" width="85.6964">
              <g id="Group">
                <path clipRule="evenodd" d={svgPaths.p1191e780} fill="url(#paint0_linear_0_168)" fillRule="evenodd" id="Vector" />
                <path d={svgPaths.p37de6300} fill="url(#paint1_linear_0_168)" id="Vector_2" />
                <path d={svgPaths.p1ee50c00} fill="white" id="Vector_3" />
                <path d={svgPaths.p35d15700} fill="url(#paint2_linear_0_168)" id="Vector_4" />
                <path d={svgPaths.pa998900} fill="white" id="Vector_5" />
                <path d={svgPaths.p1e886100} fill="url(#paint3_linear_0_168)" id="Vector_6" />
                <path d={svgPaths.p2b6c6cf0} fill="white" id="Vector_7" />
                <path d={svgPaths.p148cbb00} fill="url(#paint4_linear_0_168)" id="Vector_8" />
                <path d={svgPaths.p1da39e80} fill="white" id="Vector_9" />
              </g>
              <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_168" x1="25.9072" x2="55.5492" y1="61.4936" y2="28.5487">
                  <stop stopColor="#92278F" />
                  <stop offset="0.5" stopColor="#3777BC" />
                  <stop offset="1" stopColor="#00C0F3" />
                </linearGradient>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_168" x1="45.3728" x2="83.848" y1="15.8015" y2="27.9999">
                  <stop stopColor="white" stopOpacity="0" />
                  <stop offset="0.51" stopColor="#5C2D91" />
                  <stop offset="1" stopColor="#00AEEF" />
                </linearGradient>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_168" x1="18.8632" x2="26.3558" y1="38.4981" y2="-1.13239">
                  <stop stopColor="white" stopOpacity="0" />
                  <stop offset="0.51" stopColor="#5C2D91" />
                  <stop offset="1" stopColor="#00AEEF" />
                </linearGradient>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_168" x1="39.0032" x2="4.99172" y1="76.74" y2="55.0202">
                  <stop stopColor="white" stopOpacity="0" />
                  <stop offset="0.51" stopColor="#5C2D91" />
                  <stop offset="1" stopColor="#00AEEF" />
                </linearGradient>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_0_168" x1="67.9794" x2="58.8531" y1="45.8459" y2="85.134">
                  <stop stopColor="white" stopOpacity="0" />
                  <stop offset="0.51" stopColor="#5C2D91" />
                  <stop offset="1" stopColor="#00AEEF" />
                </linearGradient>
  ...
  return (
    <div className="absolute h-[484.718px] left-[calc(50%+87.47px)] opacity-25 top-[151px] w-[486.067px]" data-name="Isolation_Mode">
      <svg className="absolute block inset-0 size-full" fill="none" height="484.718" preserveAspectRatio="none" viewBox="0 0 486.067 484.718" width="486.067">
        <g clipPath="url(#clip0_0_191)" id="Isolation_Mode">
          <path clipRule="evenodd" d={svgPaths.peb53500} fill="url(#paint0_linear_0_191)" fillRule="evenodd" id="Vector" />
          <path d={svgPaths.p23356400} fill="url(#paint1_linear_0_191)" id="Vector_2" />
          <path d={svgPaths.pc1ee300} fill="white" id="Vector_3" />
          <path d={svgPaths.p2a8fec80} fill="url(#paint2_linear_0_191)" id="Vector_4" />
          <path d={svgPaths.p1fa3700} fill="white" id="Vector_5" />
          <path d={svgPaths.p2a0ab200} fill="url(#paint3_linear_0_191)" id="Vector_6" />
          <path d={svgPaths.p3439d200} fill="white" id="Vector_7" />
          <path d={svgPaths.p1b3fe00} fill="url(#paint4_linear_0_191)" id="Vector_8" />
          <path d={svgPaths.p2fd00f80} fill="white" id="Vector_9" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_191" x1="146.929" x2="315.214" y1="349.085" y2="162.207">
            <stop stopColor="#92278F" />
            <stop offset="0.5" stopColor="#3777BC" />
            <stop offset="1" stopColor="#00C0F3" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_191" x1="257.336" x2="475.6" y1="89.7012" y2="158.842">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_191" x1="106.981" x2="149.548" y1="218.549" y2="-6.41074">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_191" x1="221.221" x2="28.1982" y1="435.636" y2="312.485">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_0_191" x1="385.567" x2="333.719" y1="260.266" y2="483.276">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
  ...
  return (
    <div className="absolute inset-[0_0.12%_0_70.53%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" height="61.7004" preserveAspectRatio="none" viewBox="0 0 61.9245 61.7004" width="61.9245">
        <g id="Group">
          <path clipRule="evenodd" d={svgPaths.p15afe1f8} fill="url(#paint0_linear_0_158)" fillRule="evenodd" id="Vector" />
          <path d={svgPaths.p28cdd900} fill="url(#paint1_linear_0_158)" id="Vector_2" />
          <path d={svgPaths.p3f39c700} fill="white" id="Vector_3" />
          <path d={svgPaths.p2ef4e380} fill="url(#paint2_linear_0_158)" id="Vector_4" />
          <path d={svgPaths.pa073800} fill="white" id="Vector_5" />
          <path d={svgPaths.pfe29f00} fill="url(#paint3_linear_0_158)" id="Vector_6" />
          <path d={svgPaths.p34308700} fill="white" id="Vector_7" />
          <path d={svgPaths.p366c0700} fill="url(#paint4_linear_0_158)" id="Vector_8" />
          <path d={svgPaths.p3a474100} fill="white" id="Vector_9" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_158" x1="18.7206" x2="40.14" y1="44.4355" y2="20.6294">
            <stop stopColor="#92278F" />
            <stop offset="0.5" stopColor="#3777BC" />
            <stop offset="1" stopColor="#00C0F3" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_158" x1="32.7865" x2="60.5888" y1="11.4182" y2="20.2328">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_158" x1="13.6306" x2="19.0448" y1="27.8186" y2="-0.81849">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_158" x1="28.1838" x2="3.60702" y1="55.4526" y2="39.7578">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_0_158" x1="49.1221" x2="42.5274" y1="33.1283" y2="61.518">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="0.51" stopColor="#5C2D91" />
            <stop offset="1" stopColor="#00AEEF" />
          </linearGradient>
...
function LandingPage() {
  ...
  return (
    <div className="relative bg-white h-[3783px] mx-auto overflow-clip w-[1440px]" data-name="Landing Page">
      <div className="absolute bg-[#009dc4] h-[149px] left-[calc(58.33%+35px)] rounded-tl-[30px] rounded-tr-[30px] top-[754px] w-[360px] reveal-on-scroll" />
      <div className="absolute bg-[#009dc4] h-[149px] left-[calc(58.33%+35px)] rounded-tl-[30px] rounded-tr-[30px] top-[1288px] w-[360px] reveal-on-scroll" />
      <div className="absolute bg-[#009dc4] h-[149px] left-[calc(58.33%+35px)] rounded-tl-[30px] rounded-tr-[30px] top-[1822px] w-[360px] reveal-on-scroll" />
      <div className="absolute bg-[#009dc4] h-[149px] left-[calc(58.33%+35px)] rounded-tl-[30px] rounded-tr-[30px] top-[2356px] w-[360px] reveal-on-scroll" />
      <div className="absolute bg-[#009dc4] h-[149px] left-[calc(58.33%+35px)] rounded-tl-[30px] rounded-tr-[30px] top-[2890px] w-[360px] reveal-on-scroll" />
      <div className="absolute bg-white border-3 border-[#009dc4] border-solid h-[439px] left-[calc(8.33%+85px)] rounded-[30px] top-[823px] w-[1030px] reveal-on-scroll card-hover-fx" />
      <div className="absolute bg-white border-3 border-[#009dc4] border-solid h-[439px] left-[calc(8.33%+85px)] rounded-[30px] top-[1357px] w-[1030px] reveal-on-scroll card-hover-fx" />
      <div className="absolute bg-white border-3 border-[#009dc4] border-solid h-[439px] left-[calc(8.33%+85px)] rounded-[30px] top-[1891px] w-[1030px] reveal-on-scroll card-hover-fx" />
      <div className="absolute bg-white border-3 border-[#009dc4] border-solid h-[439px] left-[calc(8.33%+85px)] rounded-[30px] top-[2425px] w-[1030px] reveal-on-scroll card-hover-fx" />
      <div className="absolute bg-white border-3 border-[#009dc4] border-solid h-[439px] left-[calc(8.33%+85px)] rounded-[30px] top-[2959px] w-[1030px] reveal-on-scroll card-hover-fx" />
      <Header />
      <Layer />
      ...
      <p className="-translate-x-full [word-break:break-word] absolute font-['Hacen_Casablanca:Regular',sans-serif] leading-[54px] left-[calc(70.83%+165px)] not-italic text-[40px] text-right text-white top-[765px] w-[406px]" dir="auto">
        البـــــــرنامج الأول
      </p>
      <p className="-translate-x-full [word-break:break-word] absolute font-['Hacen_Casablanca:Regular',sans-serif] leading-[54px] left-[calc(70.83%+165px)] not-italic text-[40px] text-right text-white top-[1299px] w-[406px]" dir="auto">
        البـــــــرنامج الثاني
      </p>
      <p className="-translate-x-full [word-break:break-word] absolute font-['Hacen_Casablanca:Regular',sans-serif] leading-[54px] left-[calc(70.83%+165px)] not-italic text-[40px] text-right text-white top-[1833px] w-[406px]" dir="auto">
        البـــــــرنامج الثالث
      </p>
      <p className="-translate-x-full [word-break:break-word] absolute font-['Hacen_Casablanca:Regular',sans-serif] leading-[54px] left-[calc(70.83%+165px)] not-italic text-[40px] text-right text-white top-[2367px] w-[406px]" dir="auto">
        البـــــــرنامج الرابع
      </p>
      <p className="-translate-x-full [word-break:break-word] absolute font-['Hacen_Casablanca:Regular',sans-serif] leading-[54px] left-[calc(70.83%+165px)] not-italic text-[40px] text-right text-white top-[2901px] w-[406px]" dir="auto">
        البـــــــرنامج الخامس
      </p>
      <div className="absolute h-[395px] left-[calc(8.33%+107px)] rounded-[30px] top-[845px] w-[503px] reveal-on-scroll reveal-scale banner-hover-fx" data-name="ChatGPT Image Jul 27, 2026 at 03_39_22 PM 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[30px]">
          <img alt="" className="absolute h-[100.11%] left-0 max-w-none top-[-0.05%] w-[142.94%]" src={imgChatGptImageJul272026At033922Pm1} />
        </div>
      </div>
      <div className="absolute h-[395px] left-[calc(8.33%+107px)] rounded-[30px] top-[1379px] w-[503px] reveal-on-scroll reveal-scale banner-hover-fx" data-name="ChatGPT Image Jul 27, 2026 at 03_40_19 PM 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[30px]">
          <img alt="" className="absolute h-[100.02%] left-[-31.41%] max-w-none top-[-0.01%] w-[139.56%]" src={imgChatGptImageJul272026At034019Pm1} />
        </div>
      </div>
      <div className="absolute h-[395px] left-[calc(8.33%+107px)] rounded-[30px] top-[1913px] w-[503px] reveal-on-scroll reveal-scale banner-hover-fx" data-name="ChatGPT Image Jul 27, 2026 at 03_47_21 PM 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[30px]">
          <img alt="" className="absolute h-[100.02%] left-[-28.63%] max-w-none top-[-0.01%] w-[139.56%]" src={imgChatGptImageJul272026At034721Pm1} />
        </div>
      </div>
      <div className="absolute h-[395px] left-[calc(8.33%+107px)] rounded-[30px] top-[2447px] w-[503px] reveal-on-scroll reveal-scale banner-hover-fx" data-name="ChatGPT Image Jul 27, 2026 at 03_48_58 PM 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[30px]">
          <img alt="" className="absolute h-[100.02%] left-[-32.6%] max-w-none top-[-0.01%] w-[139.56%]" src={imgChatGptImageJul272026At034858Pm1} />
        </div>
      </div>
      <div className="absolute h-[395px] left-[calc(8.33%+107px)] rounded-[30px] top-[2981px] w-[503px] reveal-on-scroll reveal-scale banner-hover-fx" data-name="ChatGPT Image Jul 27, 2026 at 03_52_57 PM 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[30px]">
          <img alt="" className="absolute h-[159.12%] left-0 max-w-none top-[-29.43%] w-full" src={imgChatGptImageJul272026At035257Pm1} />
        </div>
      </div>
    </div>
  );
