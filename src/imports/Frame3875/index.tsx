              ...
              <div className="relative size-full">
                <svg className="absolute block inset-0 size-full" fill="none" height="66" preserveAspectRatio="none" viewBox="0 0 66 66" width="66">
                  <g id="Group 1">
                    ...
                    <g id="arrow_upward">
                      <mask height="30" id="mask0_0_183" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="30" x="18" y="18">
...
function LandingPage() {
  ...
  return (
    <div className="relative bg-white h-[3783px] mx-auto overflow-clip w-[1440px]" data-name="Landing Page">
      <div className="absolute bg-[#009dc4] h-[149px] left-[calc(58.33%+35px)] rounded-tl-[30px] rounded-tr-[30px] top-[754px] w-[360px]" />
      <div className="absolute bg-[#009dc4] h-[149px] left-[calc(58.33%+35px)] rounded-tl-[30px] rounded-tr-[30px] top-[1288px] w-[360px]" />
      <div className="absolute bg-[#009dc4] h-[149px] left-[calc(58.33%+35px)] rounded-tl-[30px] rounded-tr-[30px] top-[1822px] w-[360px]" />
      <div className="absolute bg-[#009dc4] h-[149px] left-[calc(58.33%+35px)] rounded-tl-[30px] rounded-tr-[30px] top-[2356px] w-[360px]" />
      <div className="absolute bg-[#009dc4] h-[149px] left-[calc(58.33%+35px)] rounded-tl-[30px] rounded-tr-[30px] top-[2890px] w-[360px]" />
      <div className="absolute bg-white border-3 border-[#009dc4] border-solid h-[439px] left-[calc(8.33%+85px)] rounded-[30px] top-[823px] w-[1030px]" />
      <div className="absolute bg-white border-3 border-[#009dc4] border-solid h-[439px] left-[calc(8.33%+85px)] rounded-[30px] top-[1357px] w-[1030px]" />
      <div className="absolute bg-white border-3 border-[#009dc4] border-solid h-[439px] left-[calc(8.33%+85px)] rounded-[30px] top-[1891px] w-[1030px]" />
      <div className="absolute bg-white border-3 border-[#009dc4] border-solid h-[439px] left-[calc(8.33%+85px)] rounded-[30px] top-[2425px] w-[1030px]" />
      ...
      <div className="absolute h-[395px] left-[calc(8.33%+107px)] rounded-[30px] top-[845px] w-[503px]" data-name="ChatGPT Image Jul 27, 2026 at 03_39_22 PM 1">
      ...
      <div className="absolute h-[395px] left-[calc(8.33%+107px)] rounded-[30px] top-[1379px] w-[503px]" data-name="ChatGPT Image Jul 27, 2026 at 03_40_19 PM 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[30px]">
          <img alt="" className="absolute h-[100.02%] left-[-31.41%] max-w-none top-[-0.01%] w-[139.56%]" src={imgChatGptImageJul272026At034019Pm1} />
        </div>
      </div>
      <div className="absolute h-[395px] left-[calc(8.33%+107px)] rounded-[30px] top-[1913px] w-[503px]" data-name="ChatGPT Image Jul 27, 2026 at 03_47_21 PM 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[30px]">
          <img alt="" className="absolute h-[100.02%] left-[-28.63%] max-w-none top-[-0.01%] w-[139.56%]" src={imgChatGptImageJul272026At034721Pm1} />
        </div>
      </div>
      <div className="absolute h-[395px] left-[calc(8.33%+107px)] rounded-[30px] top-[2447px] w-[503px]" data-name="ChatGPT Image Jul 27, 2026 at 03_48_58 PM 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[30px]">
          <img alt="" className="absolute h-[100.02%] left-[-32.6%] max-w-none top-[-0.01%] w-[139.56%]" src={imgChatGptImageJul272026At034858Pm1} />
        </div>
      </div>
      <div className="absolute h-[395px] left-[calc(8.33%+107px)] rounded-[30px] top-[2981px] w-[503px]" data-name="ChatGPT Image Jul 27, 2026 at 03_52_57 PM 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[30px]">
